...
print('total mass = ',np.sum(d['rho']*d['dvol'])/c.msun)
print('unbound mass =',np.sum( (d['rho']*d['dvol'])[d['etot']>0] ) / c.msun)
print('total mass + m1 ',(np.sum(d['rho']*d['dvol'])+ orb['m1'][0])/c.msun )
